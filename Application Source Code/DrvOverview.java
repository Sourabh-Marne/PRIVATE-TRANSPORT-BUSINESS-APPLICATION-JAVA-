 ...
 * @author hp
 */
public class DrvOverview extends javax.swing.JFrame {

    /**
     * Creates new form DrvOverview
     */
    public DrvOverview() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Driver Overview");
        jLabel1.setToolTipText("");
        jPanel5.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 298, 43));
        ...
        jPanel5.add(Close, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 20, 31, 39));
        ...
        jPanel5.add(Minimize, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 20, 31, 39));

        getContentPane().add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 820, 90));
        ...
        jLabel3.setText("Please Select a Driver");
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 820, 500));
...
if(s==null)
{
 JOptionPane.showMessageDialog(null,"Please select a driver and try again.","Driver Not Selected",JOptionPane.ERROR_MESSAGE);
   ...
   {
 new DriverTripInfo(s).setVisible(true);
 this.dispose(); }
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DrvOverview.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
